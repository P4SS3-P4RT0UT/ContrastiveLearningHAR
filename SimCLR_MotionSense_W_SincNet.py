...
base_model = simclr_models.create_sincnet_base_model(input_shape, model_name="sincnet_base_model", num_sinc_filters=8, sinc_kernel_size=101, sample_rate=sampling_rate, depthwise=True)
...
simclr_model_save_path = f"{working_directory}{start_time_str}_simclr_ms_w.keras"
