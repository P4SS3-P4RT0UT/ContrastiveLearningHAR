...
base_model = simclr_models.create_sincnet_base_model(input_shape, model_name="sincnet_base_model", num_sinc_filters=4, sinc_kernel_size=100, sample_rate=sampling_rate, depthwise=True)
